...
* @{
*/
#define PRODUCT_KEY "f0af899ccb114caeb9901e93047a5c1f"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "2b0c798b3bea4448a42c23e78ca6abcf"
...
* @{
*/
#define servo1_BYTEOFFSET                    0
#define servo1_BITOFFSET                     0
#define servo1_LEN                           1
#define ledflag1_BYTEOFFSET                    0
#define ledflag1_BITOFFSET                     1
#define ledflag1_LEN                           1
#define airflag1_BYTEOFFSET                    0
#define airflag1_BITOFFSET                     2
#define airflag1_LEN                           1
#define servo2_BYTEOFFSET                    0
#define servo2_BITOFFSET                     3
#define servo2_LEN                           1
#define ledflag2_BYTEOFFSET                    0
#define ledflag2_BITOFFSET                     4
#define ledflag2_LEN                           1
#define airflag2_BYTEOFFSET                    0
#define airflag2_BITOFFSET                     5
#define airflag2_LEN                           1

#define temp1_RATIO                         1
#define temp1_ADDITION                      0
#define temp1_MIN                           0
#define temp1_MAX                           100
#define humi1_RATIO                         1
#define humi1_ADDITION                      0
#define humi1_MIN                           0
#define humi1_MAX                           100
#define signnumber_RATIO                         1
#define signnumber_ADDITION                      0
#define signnumber_MIN                           0
#define signnumber_MAX                           100
#define realnumber_RATIO                         1
#define realnumber_ADDITION                      0
#define realnumber_MIN                           0
#define realnumber_MAX                           100
#define inounumber_RATIO                         1
#define inounumber_ADDITION                      0
#define inounumber_MIN                           0
#define inounumber_MAX                           100
#define temp2_RATIO                         1
#define temp2_ADDITION                      0
#define temp2_MIN                           0
#define temp2_MAX                           100
#define humi2_RATIO                         1
#define humi2_ADDITION                      0
#define humi2_MIN                           0
#define humi2_MAX                           100
#define signnumber2_RATIO                         1
#define signnumber2_ADDITION                      0
#define signnumber2_MIN                           0
#define signnumber2_MAX                           100
#define realnumber2_RATIO                         1
#define realnumber2_ADDITION                      0
#define realnumber2_MIN                           0
#define realnumber2_MAX                           100
#define inounumber2_RATIO                         1
#define inounumber2_ADDITION                      0
#define inounumber2_MIN                           0
#define inounumber2_MAX                           100
#define dust1_RATIO                         1
#define dust1_ADDITION                      0
#define dust1_MIN                           0
#define dust1_MAX                           600
#define light1_RATIO                         1
#define light1_ADDITION                      0
#define light1_MIN                           0
#define light1_MAX                           3000
#define dust2_RATIO                         1
#define dust2_ADDITION                      0
#define dust2_MIN                           0
#define dust2_MAX                           600
#define light2_RATIO                         1
#define light2_ADDITION                      0
#define light2_MIN                           0
#define light2_MAX                           3000
/**@} */
...
typedef struct {
  ...
  bool valueledflag2;
  bool valueairflag2;
  uint8_t valuedata[50];
  uint32_t valuetemp1;
  uint32_t valuehumi1;
  uint32_t valuesignnumber;
  uint32_t valuerealnumber;
  uint32_t valueinounumber;
  uint32_t valuetemp2;
  uint32_t valuehumi2;
  uint32_t valuesignnumber2;
  uint32_t valuerealnumber2;
  uint32_t valueinounumber2;
  uint32_t valuedust1;
  uint32_t valuelight1;
  uint32_t valuedust2;
  uint32_t valuelight2;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagservo1:1;
  uint8_t flagledflag1:1;
  uint8_t flagairflag1:1;
  uint8_t flagservo2:1;
  uint8_t flagledflag2:1;
  uint8_t flagairflag2:1;
  uint8_t flagdata:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuetemp1;
  uint8_t valuehumi1;
  uint8_t valuesignnumber;
  uint8_t valuerealnumber;
  uint8_t valueinounumber;
  uint8_t valuetemp2;
  uint8_t valuehumi2;
  uint8_t valuesignnumber2;
  uint8_t valuerealnumber2;
  uint8_t valueinounumber2;
  uint16_t valuedust1;
  uint16_t valuelight1;
  uint16_t valuedust2;
  uint16_t valuelight2;
} devStatus_t; 
