...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagLED1_1)
    {
        info->event[info->num] = EVENT_LED1_1;
        info->num++;
        dataPoints->valueLED1_1 = gizStandardDecompressionValue(LED1_1_BYTEOFFSET,LED1_1_BITOFFSET,LED1_1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagLED2_1)
    {
        info->event[info->num] = EVENT_LED2_1;
        info->num++;
        dataPoints->valueLED2_1 = gizStandardDecompressionValue(LED2_1_BYTEOFFSET,LED2_1_BITOFFSET,LED2_1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagLED2_2)
    {
        info->event[info->num] = EVENT_LED2_2;
        info->num++;
        dataPoints->valueLED2_2 = gizStandardDecompressionValue(LED2_2_BYTEOFFSET,LED2_2_BITOFFSET,LED2_2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueLED1_1 != cur->valueLED1_1)
    {
        GIZWITS_LOG("valueLED1_1 Changed\n");
        ret = 1;
    }
    ...
    if(last->valueLED2_1 != cur->valueLED2_1)
    {
        GIZWITS_LOG("valueLED2_1 Changed\n");
        ret = 1;
    }
    if(last->valueLED2_2 != cur->valueLED2_2)
    {
        GIZWITS_LOG("valueLED2_2 Changed\n");
        ret = 1;
    }
    if(last->valueLED1_2 != cur->valueLED1_2)
    {
        GIZWITS_LOG("valueLED1_2 Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(LED1_1_BYTEOFFSET,LED1_1_BITOFFSET,LED1_1_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED1_1);
    gizStandardCompressValue(servo2_BYTEOFFSET,servo2_BITOFFSET,servo2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueservo2);
    gizStandardCompressValue(LED2_1_BYTEOFFSET,LED2_1_BITOFFSET,LED2_1_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED2_1);
    gizStandardCompressValue(LED2_2_BYTEOFFSET,LED2_2_BITOFFSET,LED2_2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED2_2);
    gizStandardCompressValue(LED1_2_BYTEOFFSET,LED1_2_BITOFFSET,LED1_2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED1_2);
