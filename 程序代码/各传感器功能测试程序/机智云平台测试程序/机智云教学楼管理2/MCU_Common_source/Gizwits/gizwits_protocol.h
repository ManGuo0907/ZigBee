...
* @{
*/
#define PRODUCT_KEY "9e027e752714420884e451b3aa4b8c3c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "7e1f5b15db984d128fd4275aca73332e"
...
#define servo1_LEN                           1
#define LED1_1_BYTEOFFSET                    0
#define LED1_1_BITOFFSET                     1
#define LED1_1_LEN                           1
#define servo2_BYTEOFFSET                    0
#define servo2_BITOFFSET                     2
#define servo2_LEN                           1
#define LED2_1_BYTEOFFSET                    0
#define LED2_1_BITOFFSET                     3
#define LED2_1_LEN                           1
#define LED2_2_BYTEOFFSET                    0
#define LED2_2_BITOFFSET                     4
#define LED2_2_LEN                           1
#define LED1_2_BYTEOFFSET                    1
#define LED1_2_BITOFFSET                     0
#define LED1_2_LEN                           1
...
typedef struct {
  ...
  uint8_t flagLED1_1:1;
  uint8_t flagservo2:1;
  uint8_t flagLED2_1:1;
  uint8_t flagLED2_2:1;
} attrFlags_t;
