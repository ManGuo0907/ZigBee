...
* @{
*/
#define PRODUCT_KEY "e121ef18a3eb4b19b7308ce434fab767"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "1410f60e4600460699ae665be1ab4b2d"
...
#define LED2_LEN                           1
#define gear_BYTEOFFSET                    0
#define gear_BITOFFSET                     2
#define gear_LEN                           1
...
#define humi_MIN                           0
#define humi_MAX                           100
#define total_num_RATIO                         1
#define total_num_ADDITION                      0
#define total_num_MIN                           0
#define total_num_MAX                           100
#define real_num_RATIO                         1
#define real_num_ADDITION                      0
#define real_num_MIN                           0
#define real_num_MAX                           100
#define dust_RATIO                         1
#define dust_ADDITION                      0
#define dust_MIN                           0
#define dust_MAX                           600
...
typedef struct {
  ...
  uint32_t valuetemp;
  uint32_t valuehumi;
  uint32_t valuetotal_num;
  uint32_t valuereal_num;
  uint32_t valuedust;
  uint32_t valuelight;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t valuetemp;
  uint8_t valuehumi;
  uint8_t valuetotal_num;
  uint8_t valuereal_num;
  uint16_t valuedust;
  uint16_t valuelight;
} devStatus_t; 
