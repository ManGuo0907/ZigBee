  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_gear:
        ...
        if(0x01 == currentDataPoint.valuegear)
        {
          //user handle
        }
        else
...
//    currentDataPoint.valuetotal_num = ;//Add Sensor Data Collection
//    currentDataPoint.valuereal_num = ;//Add Sensor Data Collection
//    currentDataPoint.valuedust = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valuetotal_num = ;
      currentDataPoint.valuereal_num = ;
      currentDataPoint.valuedust = ;
